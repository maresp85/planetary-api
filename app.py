...
app.config['MAIL_USERNAME'] = '69b1a34a73415e'
app.config['MAIL_PASSWORD'] = '04831d0dbda62f'
...
@app.route('/not_found')
def not_found():
    return jsonify(message='Hello from the Planetary API.'), 404
...
def remove_planet(planet_id: int):
    ...
    if planet:
        ...
        db.session.commit()
        return jsonify(message='You deleted aa planet'), 202
    else:
